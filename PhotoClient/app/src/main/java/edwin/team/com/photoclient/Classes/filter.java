...
/**
 * Created by stefan on 25-Nov-14.
 */
public class filter {
...
//standard sepia (devoid of blue)
    public static Bitmap SepiaNoBlue(Bitmap src){
        int depth = 150;
        double red = .7;
        double green = 0.3;
        double blue = 0.12;//0.12;
        // image size
        int width = src.getWidth();
        int height = src.getHeight();
        // create output bitmap
...
//standard Sepia (Brown)
    public static Bitmap SepiaBrown(Bitmap src){
        int depth = 150;
        double red = 0.5;
        double green = 0.3;
        double blue = 0.12;//0.12;
...
//make custom sepia
    public static Bitmap SepiaCustom(Bitmap src, int depth, double red, double green, double blue) {
        // image size
        int width = src.getWidth();
        int height = src.getHeight();
        // create output bitmap
